/*
# Terraform VPC Infrastructure Setup for Jenkins Deployment

This Terraform configuration creates a basic VPC setup in AWS (Mumbai region - ap-south-1) to host a Jenkins infrastructure. It includes:
